...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".table { height: 200px; }\n\ntd { text-align: center; }\n\n.stones {\n    fill: #efefef;\n}\n\n.playable {\n    cursor: pointer;\n}\n\n.playable:hover {\n    fill: #aaa;\n}\n\n.table tbody>tr>td{\n    vertical-align: middle;\n}\n", ""]);
...
/***/ function(module, exports) {
	...
	var _janne$kalahelm$Main$viewTitle = function (model) {
		var title = function (winner) {
			...
			if (_p0.ctor === 'Nothing') {
				...
				switch (_p0._0.ctor) {
					case 'Player':
						return 'Game over, winner was: Human';
					case 'Opponent':
						return 'Game over, winner was: Computer';
					default:
		...
		return A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					...
					title(model.move.winner))
				]));
	};
	var _janne$kalahelm$Main$holeToPos = F2(
		function (hole, stone) {
			var _p1 = (_elm_lang$core$Native_Utils.cmp(hole, 6) < 0) ? {ctor: '_Tuple2', _0: (hole * 100) + 150, _1: 155} : (_elm_lang$core$Native_Utils.eq(hole, 6) ? {ctor: '_Tuple2', _0: 750, _1: 105} : ((_elm_lang$core$Native_Utils.cmp(hole, 13) < 0) ? {ctor: '_Tuple2', _0: ((12 - hole) * 100) + 150, _1: 55} : {ctor: '_Tuple2', _0: 50, _1: 105}));
			var x = _p1._0;
			var y = _p1._1;
			var seed = _elm_lang$core$Random$initialSeed(((x + y) + hole) + stone);
			var gen = A2(
				_elm_lang$core$Random$pair,
				A2(_elm_lang$core$Random$int, -25, 25),
				A2(_elm_lang$core$Random$int, -25, 25));
	...
	var _janne$kalahelm$Main$ownHole = F2(
		function (hole, move) {
			return _elm_lang$core$Native_Utils.eq(move.player, 0) ? ((_elm_lang$core$Native_Utils.cmp(hole, 0) > -1) && (_elm_lang$core$Native_Utils.cmp(hole, 6) < 0)) : ((_elm_lang$core$Native_Utils.cmp(hole, 7) > -1) && (_elm_lang$core$Native_Utils.cmp(hole, 13) < 0));
		});
	var _janne$kalahelm$Main$opposite = function (hole) {
		return 12 - hole;
	};
	var _janne$kalahelm$Main$stonesMissing = function (move) {
		return 48 - _elm_lang$core$List$sum(move.board);
	};
	var _janne$kalahelm$Main$otherKalaha = function (move) {
		return _elm_lang$core$Native_Utils.eq(move.player, 0) ? 13 : 6;
	};
	var _janne$kalahelm$Main$incrementFrom = F2(
		function (hole, move) {
			incrementFrom:
			while (true) {
				var kalaha = _janne$kalahelm$Main$otherKalaha(move);
				var stones = _janne$kalahelm$Main$stonesMissing(move);
				var other = ((_elm_lang$core$Native_Utils.cmp(hole, kalaha) < 0) && (_elm_lang$core$Native_Utils.cmp(hole + stones, kalaha) > -1)) ? 1 : 0;
				var incrementRange = F2(
					function (idx, value) {
						return ((_elm_lang$core$Native_Utils.cmp(idx, hole) > -1) && ((_elm_lang$core$Native_Utils.cmp(idx, (hole + stones) + other) < 0) && (!_elm_lang$core$Native_Utils.eq(idx, kalaha)))) ? (value + 1) : value;
					});
				var move$ = _elm_lang$core$Native_Utils.update(
					move,
					{
						board: A2(_elm_lang$core$List$indexedMap, incrementRange, move.board)
					});
				if (_elm_lang$core$Native_Utils.cmp(
					_janne$kalahelm$Main$stonesMissing(move$),
					0) > 0) {
					var _v1 = 0,
						_v2 = move$;
					hole = _v1;
					move = _v2;
					continue incrementFrom;
				} else {
					return {ctor: '_Tuple2', _0: move$, _1: (stones + hole) - 1};
				}
			}
		});
	var _janne$kalahelm$Main$kalaha = function (move) {
		return _elm_lang$core$Native_Utils.eq(move.player, 0) ? 6 : 13;
	};
	var _janne$kalahelm$Main$nextPlayer = F2(
		function (hole, move) {
			return (!_elm_lang$core$Native_Utils.eq(
				hole,
				_janne$kalahelm$Main$kalaha(move))) ? _elm_lang$core$Native_Utils.update(
				move,
				{
					player: A2(_elm_lang$core$Basics_ops['%'], move.player + 1, 2)
				}) : move;
		});
	var _janne$kalahelm$Main$set = F3(
		function (n, stones, board) {
			return A2(
				_elm_lang$core$Basics_ops['++'],
				A2(_elm_lang$core$List$take, n, board),
				A2(
					_elm_lang$core$Basics_ops['++'],
					_elm_lang$core$Native_List.fromArray(
						[stones]),
					A2(_elm_lang$core$List$drop, n + 1, board)));
		});
	var _janne$kalahelm$Main$get = F2(
		function (n, list) {
			return A2(
				_elm_lang$core$Maybe$withDefault,
				0,
	...
	var _janne$kalahelm$Main$steal = F2(
		function (hole, move) {
			var h3 = A2(
				_janne$kalahelm$Main$get,
				_janne$kalahelm$Main$kalaha(move),
				move.board);
			var h2 = A2(
				_janne$kalahelm$Main$get,
				_janne$kalahelm$Main$opposite(hole),
				move.board);
			var h1 = A2(_janne$kalahelm$Main$get, hole, move.board);
			return _elm_lang$core$Native_Utils.update(
				move,
				{
					board: A3(
						_janne$kalahelm$Main$set,
						_janne$kalahelm$Main$kalaha(move),
						(h1 + h2) + h3,
						A3(
							_janne$kalahelm$Main$set,
							_janne$kalahelm$Main$opposite(hole),
							0,
							A3(_janne$kalahelm$Main$set, hole, 0, move.board)))
				});
		});
	var _janne$kalahelm$Main$kalahaPlayer = function (move) {
		return A2(_janne$kalahelm$Main$get, 6, move.board);
	};
	var _janne$kalahelm$Main$kalahaOpponent = function (move) {
		return A2(_janne$kalahelm$Main$get, 13, move.board);
	};
	var _janne$kalahelm$Main$step = function (model) {
		var tails = A2(_elm_lang$core$List$filterMap, _elm_lang$core$List$tail, model.steps);
		return _elm_lang$core$Native_Utils.update(
			model,
			{
				steps: tails,
				aniMove: _elm_lang$core$Native_Utils.eq(
					tails,
					_elm_lang$core$Native_List.fromArray(
						[])) ? _elm_lang$core$Maybe$Nothing : model.aniMove
			});
	};
	var _janne$kalahelm$Main$animateSteps = F2(
		function (_p4, _p3) {
			var _p5 = _p4;
			var _p8 = _p5._1;
			var _p7 = _p5._0;
			var _p6 = _p3;
			var dy = _elm_lang$core$Basics$toFloat(_p6._1 - _p8);
			var dx = _elm_lang$core$Basics$toFloat(_p6._0 - _p7);
			var n = 60;
			var steps = A2(
				_elm_lang$core$List$map,
				function (i) {
					return _elm_community$easing_functions$Ease$outQuad(i / n);
				},
			...
			return A2(
				...
				function (f) {
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Basics$round(dx * f) + _p7,
						_1: _elm_lang$core$Basics$round(dy * f) + _p8
					};
				},
				steps);
		});
	var _janne$kalahelm$Main$animate = F2(
		function (from, to) {
			var repeatDiff = F2(
				function (a, b) {
					return A3(
						...
						F2(
							function (a$, b$) {
								return (_elm_lang$core$Native_Utils.cmp(
									...
									_elm_lang$core$Basics$snd(b$)) < 0) ? A2(
									_elm_lang$core$List$repeat,
									_elm_lang$core$Basics$snd(b$) - _elm_lang$core$Basics$snd(a$),
									_elm_lang$core$Basics$fst(a$)) : _elm_lang$core$Native_List.fromArray(
									[]);
							}),
						A2(
			...
			var fromHole = A2(
				...
				function (_p9) {
					...
					var _p11 = _p10._1;
					return A2(
						_janne$kalahelm$Main$holeToPos,
						_p11,
						A2(_janne$kalahelm$Main$get, _p11, to.board) + _p10._0);
				},
				A3(
					_elm_lang$core$List$foldl,
					F2(
					...
					A2(
						...
						A2(repeatDiff, from.board, to.board))));
			var toHole = A2(
				_elm_lang$core$List$map,
				function (_p12) {
					var _p13 = _p12;
					...
					return A2(
						_janne$kalahelm$Main$holeToPos,
						_p14,
						A2(_janne$kalahelm$Main$get, _p14, from.board) + _p13._0);
				},
				A3(
					_elm_lang$core$List$foldl,
					F2(
					...
					A2(
						...
						A2(repeatDiff, to.board, from.board))));
			var zipped = A3(
				_elm_lang$core$List$map2,
				F2(
					function (v0, v1) {
			...
			return A2(
				...
				function (_p15) {
					var _p16 = _p15;
					return A2(_janne$kalahelm$Main$animateSteps, _p16._0, _p16._1);
				},
				zipped);
		});
	var _janne$kalahelm$Main$intersection = F2(
		function (a, b) {
			return _elm_lang$core$Maybe$Just(
				_elm_lang$core$Native_Utils.update(
					a,
					{
						board: A3(
							...
							F2(
								function (a$, b$) {
									return A2(_elm_lang$core$Basics$min, a$, b$);
								}),
							a.board,
							b.board)
					}));
		});
	var _janne$kalahelm$Main$animating = function (model) {
		return _elm_lang$core$Basics$not(
			_elm_lang$core$List$isEmpty(model.steps));
	};
	var _janne$kalahelm$Main$initBoard = _elm_lang$core$Native_List.fromArray(
		[4, 4, 4, 4, 4, 4, 0, 4, 4, 4, 4, 4, 4, 0]);
	var _janne$kalahelm$Main$initMove = {board: _janne$kalahelm$Main$initBoard, player: 0, winner: _elm_lang$core$Maybe$Nothing};
	var _janne$kalahelm$Main$initModel = {
		move: _janne$kalahelm$Main$initMove,
		previousMove: _elm_lang$core$Maybe$Nothing,
		steps: _elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$core$Native_List.fromArray(
				[])
			]),
		aniMove: _elm_lang$core$Maybe$Nothing
	};
	var _janne$kalahelm$Main$init = {ctor: '_Tuple2', _0: _janne$kalahelm$Main$initModel, _1: _elm_lang$core$Platform_Cmd$none};
	var _janne$kalahelm$Main$Move = F3(
		function (a, b, c) {
			return {board: a, player: b, winner: c};
		});
	var _janne$kalahelm$Main$Model = F4(
		function (a, b, c, d) {
			return {move: a, previousMove: b, steps: c, aniMove: d};
		});
	var _janne$kalahelm$Main$Draw = {ctor: 'Draw'};
	var _janne$kalahelm$Main$Opponent = {ctor: 'Opponent'};
	var _janne$kalahelm$Main$Player = {ctor: 'Player'};
	var _janne$kalahelm$Main$winner = function (move) {
		return _elm_lang$core$Native_Utils.update(
			move,
			{
				winner: _elm_lang$core$Maybe$Just(
					function () {
						var _p17 = A2(
							...
							_janne$kalahelm$Main$kalahaPlayer(move),
							_janne$kalahelm$Main$kalahaOpponent(move));
						switch (_p17.ctor) {
							case 'LT':
								return _janne$kalahelm$Main$Opponent;
							case 'EQ':
								return _janne$kalahelm$Main$Draw;
							default:
								return _janne$kalahelm$Main$Player;
						}
					}())
			});
	};
	var _janne$kalahelm$Main$checkWinner = function (move) {
		return _elm_lang$core$Native_Utils.eq(
			_elm_lang$core$List$sum(
				A2(_elm_lang$core$List$take, 6, move.board)),
			0) ? _janne$kalahelm$Main$winner(
			_elm_lang$core$Native_Utils.update(
				move,
				{
					board: A2(
						...
						A2(
							...
							A2(
								...
								_elm_lang$core$Native_List.fromArray(
									[
										48 - _janne$kalahelm$Main$kalahaPlayer(move)
									]))))
			...
			_elm_lang$core$List$sum(
				A2(
					...
					6,
					A2(_elm_lang$core$List$drop, 7, move.board))),
			0) ? _janne$kalahelm$Main$winner(
			_elm_lang$core$Native_Utils.update(
				move,
				{
					board: A2(
						...
						A2(
							...
							_elm_lang$core$Native_List.fromArray(
								[
									48 - _janne$kalahelm$Main$kalahaOpponent(move)
								]),
							A2(
								_elm_lang$core$Basics_ops['++'],
								A2(_elm_lang$core$List$repeat, 6, 0),
	...
	var _janne$kalahelm$Main$nextMove = F2(
		function (hole, move) {
			var _p18 = A2(
				_janne$kalahelm$Main$incrementFrom,
				hole + 1,
				_elm_lang$core$Native_Utils.update(
					move,
					{
						board: A3(_janne$kalahelm$Main$set, hole, 0, move.board)
					}));
			var move$ = _p18._0;
			var last = _p18._1;
			var move$$ = (A2(_janne$kalahelm$Main$ownHole, last, move) && _elm_lang$core$Native_Utils.eq(
				A2(_janne$kalahelm$Main$get, last, move.board),
				0)) ? A2(_janne$kalahelm$Main$steal, last, move$) : move$;
			return A2(
				_janne$kalahelm$Main$nextPlayer,
				last,
				_janne$kalahelm$Main$checkWinner(move$$));
		});
	var _janne$kalahelm$Main$moveOpponent = F2(
		function (rnd, move) {
			var indexedHoles = A2(
				...
				function (_p19) {
					var _p20 = _p19;
					var _p21 = _p20._0;
					return (_elm_lang$core$Native_Utils.cmp(_p20._1, 0) > 0) && ((_elm_lang$core$Native_Utils.cmp(_p21, 7) > -1) && (_elm_lang$core$Native_Utils.cmp(_p21, 13) < 0));
				},
				A2(
					_elm_lang$core$List$indexedMap,
					F2(
			...
			var drop = A2(
				_elm_lang$core$Basics_ops['%'],
				rnd,
				_elm_lang$core$List$length(indexedHoles));
			var _p22 = _elm_lang$core$List$head(
				A2(_elm_lang$core$List$drop, drop, indexedHoles));
			if (_p22.ctor === 'Nothing') {
				return move;
			} else {
				return A2(_janne$kalahelm$Main$nextMove, _p22._0._0, move);
			}
		});
	var _janne$kalahelm$Main$Restart = {ctor: 'Restart'};
	var _janne$kalahelm$Main$Undo = {ctor: 'Undo'};
	var _janne$kalahelm$Main$Tick = {ctor: 'Tick'};
	var _janne$kalahelm$Main$subscriptions = function (model) {
		return _elm_lang$animation_frame$AnimationFrame$diffs(
			_elm_lang$core$Basics$always(_janne$kalahelm$Main$Tick));
	};
	var _janne$kalahelm$Main$MoveOpponentRandom = function (a) {
		return {ctor: 'MoveOpponentRandom', _0: a};
	};
	var _janne$kalahelm$Main$update = F2(
		function (msg, model) {
			var _p23 = msg;
			switch (_p23.ctor) {
				case 'Restart':
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							_janne$kalahelm$Main$initModel,
							{
								steps: A2(_janne$kalahelm$Main$animate, model.move, _janne$kalahelm$Main$initMove),
								aniMove: A2(_janne$kalahelm$Main$intersection, model.move, _janne$kalahelm$Main$initMove)
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				case 'NextMove':
					var next = A2(_janne$kalahelm$Main$nextMove, _p23._0, model.move);
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								previousMove: _elm_lang$core$Maybe$Just(model.move),
								move: next,
								steps: A2(_janne$kalahelm$Main$animate, model.move, next),
								aniMove: A2(_janne$kalahelm$Main$intersection, model.move, next)
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				case 'MoveOpponent':
					return {
						...
						_1: A2(
							_elm_lang$core$Random$generate,
							_janne$kalahelm$Main$MoveOpponentRandom,
							A2(_elm_lang$core$Random$int, 0, 100))
					};
				case 'MoveOpponentRandom':
					var next = A2(_janne$kalahelm$Main$moveOpponent, _p23._0, model.move);
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
						...
						return {
							...
							_0: _elm_lang$core$Native_Utils.update(
								model,
								{
									move: _p25,
									previousMove: _elm_lang$core$Maybe$Nothing,
									steps: A2(_janne$kalahelm$Main$animate, model.move, _p25),
									aniMove: A2(_janne$kalahelm$Main$intersection, model.move, _p25)
								}),
							_1: _elm_lang$core$Platform_Cmd$none
						};
					}
				default:
					return {
						ctor: '_Tuple2',
						_0: _janne$kalahelm$Main$step(model),
						_1: _elm_lang$core$Platform_Cmd$none
					};
			}
		});
	var _janne$kalahelm$Main$MoveOpponent = {ctor: 'MoveOpponent'};
	var _janne$kalahelm$Main$viewButtons = function (model) {
		var drawButton = F4(
			function (msg, title, primary, disabled) {
				var cl = primary ? 'btn btn-primary' : 'btn btn-default';
				var view = A2(
					_elm_lang$html$Html$button,
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html_Attributes$class(cl),
				...
				return _elm_lang$core$Maybe$Just(view);
			});
		var nextButton = function (disabled) {
			return (!_elm_lang$core$Native_Utils.eq(model.move.winner, _elm_lang$core$Maybe$Nothing)) ? A4(drawButton, _janne$kalahelm$Main$Restart, 'Restart', true, disabled) : (_elm_lang$core$Native_Utils.eq(model.move.player, 1) ? A4(drawButton, _janne$kalahelm$Main$MoveOpponent, 'Next', true, disabled) : _elm_lang$core$Maybe$Nothing);
		};
		var undoButton = function (disabled) {
			return _elm_lang$core$Native_Utils.eq(model.previousMove, _elm_lang$core$Maybe$Nothing) ? _elm_lang$core$Maybe$Nothing : A4(drawButton, _janne$kalahelm$Main$Undo, 'Undo', false, disabled);
		};
		return A2(
			_elm_lang$html$Html$div,
			_elm_lang$core$Native_List.fromArray(
			...
			A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						nextButton(
						_janne$kalahelm$Main$animating(model)),
						undoButton(
						_janne$kalahelm$Main$animating(model))
					])));
	};
	var _janne$kalahelm$Main$NextMove = function (a) {
		return {ctor: 'NextMove', _0: a};
	};
	var _janne$kalahelm$Main$viewBoard = function (model) {
		var circle = function (_p26) {
			var _p27 = _p26;
			return A2(
		...
		var drawStone = F2(
			function (hole, stone) {
				return circle(
					A2(_janne$kalahelm$Main$holeToPos, hole, stone));
			});
		var animatedStone = function (model) {
			var positions = A2(_elm_lang$core$List$filterMap, _elm_lang$core$List$head, model.steps);
			return A2(
				_elm_lang$core$List$map,
				function (pos) {
					return circle(pos);
		...
		var opponentAttrs = function (stones) {
			return (_elm_lang$core$Native_Utils.cmp(stones, 0) > 0) ? _elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$svg$Svg_Attributes$class('stones')
				]) : _elm_lang$core$Native_List.fromArray(
				[]);
		};
		var move = function () {
			var _p28 = model.aniMove;
		...
		var holes1 = A2(_elm_lang$core$List$take, 6, move.board);
		var holes2 = A2(
		...
		var playerAttrs = F2(
			function (i, stones) {
				return ((_elm_lang$core$Native_Utils.cmp(stones, 0) > 0) && _elm_lang$core$Native_Utils.eq(move.player, 0)) ? _elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$svg$Svg_Attributes$class('stones playable'),
						_elm_lang$html$Html_Events$onClick(
						_janne$kalahelm$Main$NextMove(i))
					]) : _elm_lang$core$Native_List.fromArray(
					[]);
			});
		return A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					...
					_elm_lang$svg$Svg_Attributes$rx('40'),
					_elm_lang$svg$Svg_Attributes$ry('40'),
					_elm_lang$svg$Svg_Attributes$viewBox('0 0 800 210')
				]),
			A2(
				_elm_lang$core$Basics_ops['++'],
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								...
								_elm_lang$svg$Svg_Attributes$rx('10'),
								_elm_lang$svg$Svg_Attributes$ry('10'),
				...
				A2(
					...
					A2(
						...
						_elm_lang$core$Native_List.range(
							0,
							_janne$kalahelm$Main$kalahaOpponent(move) - 1)),
					A2(
						_elm_lang$core$Basics_ops['++'],
						A2(
							_elm_lang$core$List$map,
							...
							_elm_lang$core$Native_List.range(
								0,
								_janne$kalahelm$Main$kalahaPlayer(move) - 1)),
						A2(
							_elm_lang$core$Basics_ops['++'],
							A3(
								_elm_lang$core$List$foldl,
									...
									F2(
										function (i, cnt) {
											return A2(
												_elm_lang$core$List$map,
												drawStone(12 - i),
												_elm_lang$core$Native_List.range(0, cnt - 1));
										}),
									holes2)),
							A2(
								_elm_lang$core$Basics_ops['++'],
												...
												A2(
													...
													_elm_lang$core$Native_List.fromArray(
														[
															...
															_elm_lang$core$Basics$toString((100 * i) + 105)),
															_elm_lang$svg$Svg_Attributes$y('10'),
															_elm_lang$svg$Svg_Attributes$width('90'),
												...
												[
													...
													_elm_lang$core$Native_List.fromArray(
														[
															...
															_elm_lang$svg$Svg_Attributes$height('190'),
															_elm_lang$svg$Svg_Attributes$rx('40'),
															_elm_lang$svg$Svg_Attributes$ry('40'),
															_elm_lang$svg$Svg_Attributes$fillOpacity('0.5')
														]),
													...
													_elm_lang$core$Native_List.fromArray(
														[
															_elm_lang$svg$Svg_Attributes$x('710'),
															_elm_lang$svg$Svg_Attributes$y('10'),
															_elm_lang$svg$Svg_Attributes$width('80'),
															_elm_lang$svg$Svg_Attributes$height('190'),
															_elm_lang$svg$Svg_Attributes$rx('40'),
	...
	var _janne$kalahelm$Main$view = function (model) {
		return A2(
			_elm_lang$html$Html$div,
			_elm_lang$core$Native_List.fromArray(
				[
			...
			_elm_lang$core$Native_List.fromArray(
				[
					_janne$kalahelm$Main$viewTitle(model),
					_janne$kalahelm$Main$viewBoard(model),
					_janne$kalahelm$Main$viewButtons(model)
				]));
	};
	var _janne$kalahelm$Main$main = {
		main: _elm_lang$html$Html_App$program(
			{init: _janne$kalahelm$Main$init, view: _janne$kalahelm$Main$view, update: _janne$kalahelm$Main$update, subscriptions: _janne$kalahelm$Main$subscriptions})
	};

	var Elm = {};
	Elm['Main'] = Elm['Main'] || {};
	_elm_lang$core$Native_Platform.addPublicModule(Elm['Main'], 'Main', typeof _janne$kalahelm$Main$main === 'undefined' ? null : _janne$kalahelm$Main$main);
